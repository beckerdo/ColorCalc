...
public class HSLColorGUITest extends JPanel implements ChangeListener {
	...
	private void updateRGB() {
		hslColor = new HSLColor((Integer) hue.getValue(), (Integer) saturation.getValue(),
				(Integer) luminance.getValue());
